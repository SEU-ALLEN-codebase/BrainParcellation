...
def get_me_mips_r1(mefile, shape3d, histeq, flip_to_left, mode, findex, axids=(2,), thickX2=20, disp_right_hemi=False, use_me_feature=True):
...
# left right symmetry estimation, for response to reviewer purpose
def plot_left_right_corr(mefile, outfile, histeq=True, mode='composite', findex=0):
    ...
    mask = load_image(MASK_CCF25_FILE)  # z,y,x order!
    shape3d = mask.shape
    mips = get_me_mips_r1(mefile, shape3d, False, False, mode, findex, axids=(0,1,2), thickX2=5)
